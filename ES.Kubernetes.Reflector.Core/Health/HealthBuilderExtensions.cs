...
namespace ES.Kubernetes.Reflector.Core.Health
{
    ...
    {
        public static ContainerBuilder AddHealthCheck<T>(this ContainerBuilder builder,
            HealthStatus? failureStatus = null, IEnumerable<string> tags = null) where T : IHealthCheck
        {
        ...
        public static ContainerBuilder AddHealthCheck<T>(this ContainerBuilder builder, string name,
            HealthStatus? failureStatus = null, IEnumerable<string> tags = null) where T : IHealthCheck
        {
        ...
        public static ContainerBuilder AddHealthCheck(this ContainerBuilder builder,
